    ...
    <header class="editorial-page site-header pb-0" aria-label="Site header">
      <div class="frosted-shell header-shell relative flex min-h-[58px] flex-wrap items-center justify-between gap-x-5 gap-y-2 px-4 sm:px-5">
        ...
        <div class="header-actions">
          ...
          <span class="hidden items-center gap-[7px] font-mono text-[10px] uppercase tracking-[.13em] text-text-muted md:inline-flex"><i class="inline-block size-[5px] animate-pulse rounded-full bg-emerald shadow-[0_0_8px_rgb(0_200_83/.6)]" />{mode() === 'MANGA' ? 'Manga catalog' : 'Anime catalog'}</span>
