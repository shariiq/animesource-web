...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  headers: () => ({
    // Browsers ignore CSP meta tags injected after the initial document, so
    // the policy ships as a response header instead of a static meta tag.
    ...
    <html lang="en">
      ...
      <body>
        <div class="app-background" aria-hidden="true">
          <div class="atmosphere-cloud atmosphere-cloud--warm" />
          <div class="atmosphere-cloud atmosphere-cloud--cool" />
          <div class="atmosphere-cloud atmosphere-cloud--pearl" />
          <div class="atmosphere-gloss" />
        </div>
        <HeadContent />
        {props.children}
        <Scripts />
